...
export default function Page({ params }: { params: { questId: string } }) : React.JSX.Element {
  ...
  return (
    <Stack spacing={3}>
      ...
      {/*          <Typography variant="body2">{quest.from_course.term.start_date} - {quest.from_course.term.end_date}</Typography>*/}
      {/*        </Grid>*/}
      {/*      </Grid>*/}
      {/*    </CardContent>*/}
      {/*    <CardActions sx={{ justifyContent: 'center' }}>*/}
      {/*      <Button endIcon={<GameControllerIcon/>} variant="contained">Start Quest</Button>*/}
      {/*    </CardActions>*/}
      {/*  </Card> : null}*/}
