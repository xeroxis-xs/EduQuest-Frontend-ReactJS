      ...
      {courseBadges.map((courseBadge) => (
        <Grid key={courseBadge.id} lg={3} md={4} xs={12} >
          <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <CardActionArea href={`/dashboard/badge/${courseBadge.id.toString()}` } sx={{ height: '100%', borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }}>
            ...
            {/*<Box>*/}
              ...
              {/*    </Typography>*/}
              {/*  </Box>*/}
              {/*  {educourseUser && course.enrolled_users.find(user => user.user === educourseUser?.id) ? (*/}
